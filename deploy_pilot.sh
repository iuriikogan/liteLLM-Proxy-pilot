...
echo -e "1. Ensure 'dqc-security-template' exists in Model Armor."
echo -e "2. Port-forward to test locally:"
echo -e "   kubectl port-forward svc/litellm-service 4000:80"
echo -e "3. Verify caching by sending two similar prompts to http://localhost:4000"
echo -e "${BLUE}====================================================${NC}"
